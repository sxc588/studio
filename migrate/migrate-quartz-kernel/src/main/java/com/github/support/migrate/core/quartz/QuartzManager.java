...
public class QuartzManager
{
	...
	private static String GROUP_NAME_JOB = "JOBGROUP_NAME";

	private static String GROUP_NAME_TRIGGER = "TRIGGERGROUP_NAME";
								...
								String cronExpression) throws ParseException, SchedulerException
	{
		...
		jobDetail.getJobDataMap().put("JOB_PARM", jobName);
	...
	{
		Scheduler scheduler = gSchedulerFactory.getScheduler();
		JobKey jobKey = JobKey.jobKey(jobName, GROUP_NAME_JOB);
