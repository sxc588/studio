...
<a href="export" class="btn btn-success" role="button">批量暂停</a>
<a href="export" class="btn btn-success" role="button">批量恢复</a>
<a href="input2" class="btn btn-success" role="button">批量修改</a>
<a href="export" class="btn btn-success" role="button">批量删除</a>
<a href="export" class="btn btn-success" role="button">导出</a>

<a href="export" class="btn btn-success" role="button">导入</a>
<a href="export" class="btn btn-success" role="button">导入模板下载</a>
<p class="lead">数据库中的任务</p>
<table class="table table-bordered table-margin-top">
    <tr><td><input id="allboxs" onclick="allcheck()" type="checkbox"/></td>
...
<!--         <td>任务执行url</td> -->
    ...
    <c:forEach items="${scheduleJobVoList}" var="item" varStatus="id"
				begin="0">
				<tr>
				<td><input id="allboxs" onclick="allcheck()" type="checkbox"/></td>
					<td>${item.jobGroup}</td>
					<td title = ${item.aliasName}>${item.jobName}</td>
