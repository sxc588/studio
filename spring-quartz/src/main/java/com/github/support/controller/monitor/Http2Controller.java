 ...
 */
@Controller
@RequestMapping(value = "/monitor/http2")
public class Http2Controller extends SimpleFormatter
{
	private static Logger log = LoggerFactory.getLogger(Http2Controller.class);
	...
	public String edit(HttpServletRequest request, Model model)
	{
		...
		return "/monitor/http2/configsEdit";
	}
	...
	public String list(ModelMap modelMap)
	{
		...
		long end = System.currentTimeMillis();
		log.info(">>edit.save" + (end - begin));
		return "/monitor/http2/configsList";
	}
