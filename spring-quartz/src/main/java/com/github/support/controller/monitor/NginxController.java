 ...
 * author : benjamin
 * 
 * createTime : 2017.06.06 description : 应用列表控制器 version : 1.0
 */
@Controller
@RequestMapping(value = "/monitor/ngx")
public class NginxController {
	private static Logger logger = LoggerFactory.getLogger(NginxController.class);
