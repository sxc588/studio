...
/**
 *  * @author leon  * @createDate 2018年11月14日 上午11:33:37  * @version v1.0
 *  * @classRemarks 图形验证码  
 */
public class ValidateCodeV2 {
	 ...
	 * @param height            图片高
	 */
	public ValidateCodeV2(int width, int height) {
		this.width = width;
		this.height = height;
		this.createCode();
	}
	 ...
	 */
	public ValidateCodeV2(int width, int height, int codeCount, int lineCount) {
		this.width = width;
		this.height = height;
	...
	public void createCode() {
		...
		/*
		 * // 将图像填充为白色 g.setColor(Color.WHITE); g.fillRect(0, 0, width, height);
		 */
	...
	public static void main(String[] args) {
		ValidateCodeV2 vCode = new ValidateCodeV2(160, 40, 5, 0);
		try {
