...
public class HttpClient11
{
	public static void main(String args[]) throws Exception
	{
		...
		// 取cookie
		List<String> cookie = getCookie("test", "test", loginAction);
		...
		for (int i = 1; i <= 3; i++)
		{
			...
			{// 拿到每个帖子的地址
				String content = doRead(cookie.toString(), all[x]);
	 ...
	 * @throws Exception
	 */
	public static List<String> getCookie(String username, String password, String loginAction) throws Exception
	{
		// 登录
