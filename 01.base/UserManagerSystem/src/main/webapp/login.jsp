		...
		<TR>
			<TD align=middle>
				<TABLE cellSpacing=0 cellPadding=0 width=468 border=0>
					<TR>
						<TD align=left><IMG height=23 src="images/login_1.jpg" width=468></TD>
					</TR>
					<TR>
						<TD align=left><IMG height=147 src="images/login_2.jpg" width=468></TD>
					</TR>
				</TABLE>
								...
								<FORM action="common/login" method="post">
									...
									<TR height=36>
										...
										<TD><INPUT
											...
											maxLength=30 size=24 name="user.username"></TD>
									</TR>
									<TR height=36>
										<TD>&nbsp;</TD>
										<TD>密 码</TD>
										<TD><INPUT
											style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid"
											type=password maxLength=30 size=24 name="user.password"></TD>
									</TR>
									<TR height=5>
										<TD colSpan=3></TD>
									</TR>
				...
				<TABLE cellSpacing=0 cellPadding=0 width=468 border=0>
					<TR>
						<TD align=right><A href="http://www.865171.cn/" target=_blank></A></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
