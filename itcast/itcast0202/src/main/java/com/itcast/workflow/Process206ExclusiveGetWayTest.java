 ...
 * 
 */
public class Process206ExclusiveGetWayTest
{
	...
	public void s01_deploymentProcess()
	{
		...
		InputStream in1 = this.getClass().getResourceAsStream("/diagrams/exclusiveGeteWay.bpmn");// 从classpath根目录下加载指定名称的文件
		InputStream in2 = this.getClass().getResourceAsStream("/diagrams/exclusiveGeteWay.png"); // 从当前包等下架子指定的文件
		// InputStream in1 =
		...
		String resourceName1 = "exclusiveGeteWay.bpmn";
		String resourceName2 = "exclusiveGeteWay.png";
		Deployment deployment = repositoryService.createDeployment() // 创建一个部署对象
				.name("流程定义-exclusiveGeteWay") // 添加的部署名称
