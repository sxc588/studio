...
//      mail.setMultipart("D:你你你.txt");
		...
		/*
		 * List<String> fileList = new ArrayList<String>(); fileList.add("D:1.jpg");
		 * fileList.add("D:activation.zip"); fileList.add("D:dstz.sql");
		 * fileList.add("D:软件配置要求.doc"); mail.setMultiparts(fileList);
		 */
