...
public class BbsAction extends MySuperAction {
	...
	public ActionForward addBbs(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
		...
		if(validate==null||validate.equals("")||!validate.equals("yes")){
			...
			String sql="insert into tb_bbs(bbs_boardID,bbs_title,bbs_content,bbs_sender,bbs_sendTime,bbs_face,bbs_opTime,bbs_isTop,bbs_isGood) values(?,?,?,?,?,?,?,?,?)";
			Object[] params={boardId,bbsTitle,bbsContent,bbsSender,bbsSendTime,bbsFace,bbsOpTime,bbsIsTop,bbsIsGood};
