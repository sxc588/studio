...
public class DekotaController
{
	...
	public @ResponseBody
	String say(@PathVariable(value = "msg")
	String msg)
	{
	...
	public @ResponseBody
	Person getPerson(@PathVariable("id")
	int id)
	{
	...
	// @RequestMapping(value = "/person/{id:\\d+}", method =
	...
	public @ResponseBody
	List<Person> listPerson(@RequestParam(value = "name", required = false, defaultValue = "")
	String name)
	{
